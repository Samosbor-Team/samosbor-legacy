...
/area/security/armoury
	name = "\improper Military - Armory"
	icon_state = "Warden"

/area/security/checkpoint2
	name = "\improper Military - Checkpoint"
	icon_state = "checkpoint1"

/area/security/detectives_office
	name = "\improper Military - Forensic Office"
	icon_state = "detective"
	sound_env = MEDIUM_SOFTFLOOR

/area/security/medical_office
	name = "\improper Military - Medical"
	icon_state = "detective"
	sound_env = MEDIUM_SOFTFLOOR
...
/area/security/range
	name = "\improper Military - Firing Range"
