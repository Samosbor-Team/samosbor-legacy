...
/datum/map/victory
	name = "Victory"
	full_name = "Space Outpost Victory"
	path = "victory"

	lobby_icon = 'maps/victory/victory_lobby.dmi'
	...
	station_name  = "Space Station victory"
	station_short = "Victory"
	dock_name     = "NTTM1-34 Relay"
...
/datum/map/victory/perform_map_generation()
