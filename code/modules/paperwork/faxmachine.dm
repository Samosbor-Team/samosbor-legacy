...
/obj/machinery/photocopier/faxmachine/proc/send_admin_fax(var/mob/sender, var/destination)
	...
	if (destination == using_map.boss_name)
		message_admins(sender, "[ruppertext(destination)] FAX", rcvdcopy, destination, "#006100")
	else if (destination == "Colonial Marshal Service")
		message_admins(sender, "[ruppertext(destination)] FAX", rcvdcopy, destination, "#1F66A0")
	else if (destination == "[using_map.boss_short] Supply")
		message_admins(sender, "[ruppertext(destination)] FAX", rcvdcopy, destination, "#5F4519")
	else if (destination in using_map.map_admin_faxes)
		message_admins(sender, "[ruppertext(destination)] FAX", rcvdcopy, destination, "#510B74")
	else
