...
/obj/item/weapon/paper/valentinka
	name = "love message"
	icon = 'icons/obj/bureaucracy.dmi'
	icon_state = "valentinka"
	item_state = "valentinka"


/obj/item/weapon/paper/valentinka/update_icon()
		return