...
/obj/effect/landmark/corpse
	...
	var/corpseidaccess = null //This is for access. See access.dm for which jobs give what access. Again, put in quotes. Use "Statthalter" if you want it to be all access.
