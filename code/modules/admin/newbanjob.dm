...
/proc/AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, rank)
	...
	if(rank == "Heads")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Kanzler")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Statthalter")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Kommandant")
