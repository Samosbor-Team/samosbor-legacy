...
/obj/machinery/power/apc/autoinit

/obj/machinery/power/apc/autoinit/New(turf/loc, var/ndir, var/building=0)
	..(loc, ndir, building)
	init()
...
/obj/machinery/power/apc/init()
	...
	pixel_x = (src.tdir & 3)? 0 : (src.tdir == 4 ? 29 : -29)
	pixel_y = (src.tdir & 3)? (src.tdir ==1 ? 29 : -29) : 0
