...
/obj/item/clothing/head/beret/sec/navy/kommandant
...
/obj/item/clothing/head/beret/guard
	name = "corporate security beret"
	desc = "A white beret adorned with the crest of Kaiserliche Kolonialgenung. For security guards that are more inclined towards style than safety."
