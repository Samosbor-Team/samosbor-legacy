...
/obj/item/clothing/suit/space/void/medical
	...
	desc = "A sterile voidsuit with minor radiation shielding and a suite of self-cleaning technology. Standard issue in Kaiserliche Kolonialgenung medical facilities."
	item_state_slots = list(
...
/obj/item/clothing/head/helmet/space/void/security
	name = "helmet 'Stahlschale'"
	desc = "A comfortable power helmet with cranial armor and eight-channel surround sound."
	icon_state = "rig0-sec"
	item_state = "sec_helm"
	armor = list(melee = 60, bullet = 45, laser = 15, energy = 5, bomb = 45, bio = 100, rad = 10)
	siemens_coefficient = 0.7
	light_overlay = "helmet_light_dual"

/obj/item/clothing/suit/space/void/security
	icon_state = "rig-sec"
	name = "power armor 'Stahlschale'"
	desc = "A somewhat kaiserreich's army powe armor layered with impact and laser-resistant armor plating. Specially designed to fighting in space."
	armor = list(melee = 60, bullet = 45, laser = 15, energy = 5, bomb = 45, bio = 100, rad = 10)
...
/obj/item/clothing/suit/space/void/atmos/alt
	desc = "An expensive Kaiserliche Kolonialgenung voidsuit, rated to withstand extreme heat and even minor radiation without exceeding room temperature within."
