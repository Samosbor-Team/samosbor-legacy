...
/obj/item/clothing/suit/storage/toggle/hoodie/nt
	name = "Kaiserliche Kolonialgenung hoodie"
	desc = "A warm, blue sweatshirt.  It proudly bears the silver Kaiserliche Kolonialgenung insignia lettering on the back.  The edges are trimmed with silver."
...
/obj/item/clothing/suit/poncho/roles/security
	...
	desc = "A simple, comfortable cloak without sleeves. This one is black and red, standard Kaiserliche Kolonialgenung Security colors."
...
/obj/item/clothing/suit/poncho/roles/science
	name = "science poncho"
	desc = "A simple, comfortable cloak without sleeves. This one is white with purple trim, standard Kaiserliche Kolonialgenung Science colors."
