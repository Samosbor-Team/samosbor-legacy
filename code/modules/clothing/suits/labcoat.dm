...
/obj/item/clothing/suit/storage/toggle/labcoat/science
	name = "\improper Kaiserliche Kolonialgenung labcoat"
	desc = "A suit that protects against minor chemical spills. Has a red stripe on the shoulder and red trim on the sleeves, denoting it as a Kaiserliche Kolonialgenung labcoat."
	icon_state = "labcoat_nt_open"
	icon_open = "labcoat_nt_open"
	icon_closed = "labcoat_nt"

/obj/item/clothing/suit/storage/toggle/labcoat/rd
	name = "Direktor der Forschung's labcoat"
	desc = "A full-body labcoat covered in red and black designs, denoting it as a Kaiserliche Kolonialgenung management coat. Judging by the amount of designs on it, it is only to be worn by the most enthusiastic of Kaiserliche Kolonialgenung employees."
