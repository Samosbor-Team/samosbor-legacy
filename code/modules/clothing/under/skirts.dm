...
/obj/item/clothing/under/rank/engineer/chief_engineer/skirt
	...
	name = "Chefingenieur's jumpskirt"
	icon_state = "chieff"
	worn_state = "chieff"
...
/obj/item/clothing/under/rank/security/head_of_security/skirt
	desc = "It's a fashionable jumpskirt worn by those few with the dedication to achieve the position of \"Kommandant\". It has additional armor to protect the wearer."
	name = "Kommandant's jumpskirt"
	icon_state = "hosredf"
	item_state = "r_suit"
	worn_state = "hosredf"