...
/obj/item/clothing/under/rank/captain //Alright, technically not a 'civilian' but its better then giving a .dm file for a single define.
	desc = "It's a blue jumpsuit with some gold markings denoting the rank of \"Statthalter\"."
	name = "Statthalter's jumpsuit"
	icon_state = "captain"
	item_state = "b_suit"
	worn_state = "captain"
...
/obj/item/clothing/under/rank/head_of_personnel
	desc = "It's a jumpsuit worn by someone who works in the position of \"Kanzler\"."
	name = "Kanzler's jumpsuit"
	icon_state = "hop"
	item_state = "b_suit"
	worn_state = "hop"
