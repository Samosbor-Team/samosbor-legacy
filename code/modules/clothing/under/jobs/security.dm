...
/obj/item/clothing/under/rank/guard
	desc = "A durable uniform worn by Kaiserliche Kolonialgenung corporate security."
	name = "\improper Kaiserliche Kolonialgenung security uniform"
	icon_state = "ntguard"
	item_state = "r_suit"
	worn_state = "ntguard"
	armor = list(melee = 10, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0)
...
/obj/item/clothing/under/rank/head_of_security
	desc = "It's a jumpsuit worn by those few with the dedication to achieve the position of \"Kommandant\". It has additional armor to protect the wearer."
	name = "Kommandant's jumpsuit"
	icon_state = "hos"
	item_state = "r_suit"
	worn_state = "hosred"
	armor = list(melee = 10, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0)
...
/obj/item/clothing/head/kommandant
	name = "Kommandant Hat"
	desc = "The hat of the Kommandant. For showing the officers who's in charge."
	icon_state = "hoscap"
	body_parts_covered = 0
	siemens_coefficient = 0.8

/obj/item/clothing/head/kommandant/dermal
...
/obj/item/clothing/suit/armor/kommandant/jensen
...
/obj/item/clothing/under/rank/head_of_security/navyblue
	desc = "The insignia on this uniform tells you that this uniform belongs to the Kommandant."
	name = "Kommandant's uniform"
