...
/obj/item/clothing/under/rank/research_director
	...
	name = "Direktor der Forschung's jumpsuit"
	icon_state = "director"
	item_state = "lb_suit"
	worn_state = "director"
...
/obj/item/clothing/under/rank/scientist
	name = "\improper Kaiserliche Kolonialgenung polo and pants"
	desc = "A fashionable polo and pair of trousers made from patented biohazard-resistant synthetic fabrics. The colors denote the wearer as a member of Kaiserliche Kolonialgenung."
	icon_state = "ntsmock"
	item_state = "w_suit"
	worn_state = "ntsmock"
...
/obj/item/clothing/under/rank/scientist/executive
	name = "\improper Kaiserliche Kolonialgenung executive polo and pants"
	desc = "A fashionable polo and pair of trousers made from expensive biohazard-resistant fabrics. The colors denote the wearer as a member of Kaiserliche Kolonialgenung's higher-ups."
