...
/obj/item/clothing/accessory/nt_tunic
	name = "\improper Kaiserliche Kolonialgenung tunic"
	desc = "A fashionable tunic that Kaiserliche Kolonialgenung gives to its lab workers."
	icon_state = "nttunic"

/obj/item/clothing/accessory/nt_tunic/exec
	name = "\improper Kaiserliche Kolonialgenung executive tunic"
...
/obj/item/clothing/accessory/toggleable/nanotrasen_jacket
	name = "\improper Kaiserliche Kolonialgenung suit jacket"
	desc = "A jacket that Kaiserliche Kolonialgenung has its executives wear."
