...
/obj/item/clothing/accessory/nt
	name = "\improper Kaiserliche Kolonialgenung tie with a clip"
...
/obj/item/clothing/accessory/medal/iron/nanotrasen
	name = "\improper Kaiserliche Kolonialgenung merit medal"
	desc = "An iron medal awarded to Kaiserliche Kolonialgenung employees for merit."
	icon_state = "iron_nt"
...
/obj/item/clothing/accessory/medal/bronze/nanotrasen
	name = "\improper Kaiserliche Kolonialgenung sciences medal"
	desc = "A bronze medal awarded to Kaiserliche Kolonialgenung employees for signifigant contributions to the fields of science or engineering."
...
/obj/item/clothing/accessory/medal/silver/nanotrasen
	name = "\improper Kaiserliche Kolonialgenung service medal"
	desc = "A silver medal awarded to Kaiserliche Kolonialgenung employees for distinguished service in support of corporate interests."
...
/obj/item/clothing/accessory/medal/gold/nanotrasen
	name = "\improper Kaiserliche Kolonialgenung command medal"
	desc = "A gold medal awarded to Kaiserliche Kolonialgenung employees for service as the Statthalter of a Kaiserliche Kolonialgenung facility, station, or vessel."
	icon_state = "gold_nt"
...
/obj/item/clothing/accessory/rank/fleet/officer/o6
	...
	desc = "Insignia denoting the rank of Statthalter."
