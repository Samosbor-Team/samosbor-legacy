...
/datum/nanoui/proc/add_common_assets()
	...
	add_custom_file("aero-matics-stencil-webfont.eot", 'html/browser/aero-matics-stencil-webfont.eot')
...
/datum/nanoui/proc/add_custom_file(name, file)
	custom_files[name] = file
...
/datum/nanoui/proc/get_html()
	...
	for(var/filename in custom_files)
		user << browse_rsc(custom_files[filename], filename)
