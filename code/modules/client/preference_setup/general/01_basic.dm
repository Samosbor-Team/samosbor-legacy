...
/datum/category_item/player_setup_item/general/basic/content()
	...
	. += "<b>Семья</b>: <a href='?src=\ref[src];family=1'>[pref.family ? "Есть" : "Нет"]</a><br/>"
...
/datum/category_item/player_setup_item/general/basic/OnTopic(var/href,var/list/href_list, var/mob/user)
	...
	if(href_list["rename"])
		...
		var/new_metadata = sanitize(input(user, "Enter any information you'd like others to see, such as Roleplay-preferences:", "Game Preference" , pref.metadata)) | null
