...
/datum/trade_destination/centcomm
	name = "CentComm"
	description = "Kaiserliche Kolonialgenung's administrative centre for Tau Ceti."
	distance = 1.2
	willing_to_buy = list()
...
/datum/trade_destination/beltway
	...
	description = "A co-operative effort between Beltway and Kaiserliche Kolonialgenung to exploit the rich outer asteroid belt of the Tau Ceti system."
	distance = 7.5
	willing_to_buy = list()
	willing_to_sell = list()
