...
/obj/item/modular_computer
	...
	var/obj/item/weapon/computer_hardware/card_slot/card_slot						// ID Card slot component of this computer. Mostly for Kanzler modification console that needs ID slot for modification.
