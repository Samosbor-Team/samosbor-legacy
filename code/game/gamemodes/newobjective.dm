	...
	objective
		...
		steal
			...
			captainslaser
				...
				explanation_text = "Steal the Statthalter's antique laser gun."
				weight = 20
			...
			steal/captainssuit
				...
				explanation_text = "Steal a Statthalter's rank jumpsuit"
				weight = 50
			...
			*/
			...
			/*burger
				...
				explanation_text = "Steal a burger made out of human organs, this will be presented as proof of Kaiserliche Kolonialgenung's chronic lack of standards."
				weight = 60
			...
			/*magboots
				...
				explanation_text = "Steal a pair of \"Kaiserliche Kolonialgenung\" brand magboots."
				weight = 20
