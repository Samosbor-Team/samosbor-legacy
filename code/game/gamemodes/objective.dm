...
/*datum/objective/brand //HERETIC
	find_target()
		..()
		if (owner && owner.religion == ILLEGAL_IDEOLOGY)
			if(find_target_by_role("Direktor der Geheimpolizei") )
				target = find_target_by_role("Direktor der Geheimpolizei")
		if(target && target.current)
...
datum/objective/steal
	...
	var/global/possible_items[] = list(
		"the Statthalter's antique laser gun" = /obj/item/weapon/gun/energy/captain,		"the Statthalter's robes" = /obj/item/clothing/suit/robes,
		"the Kommandant's uniform" = /obj/item/clothing/under/rank/head_of_security/corp,
		"the Kanzler's headset" = /obj/item/device/radio/headset/heads/hop,
		"the Kommandant's uniform" = /obj/item/clothing/under/rank/head_of_security/corp,
		"the Direktor der Geheimpolizei's helmet" = /obj/item/clothing/head/helmet/arbiter/supreme,
		"the pinpointer" = /obj/item/weapon/pinpointer,
	)
	// OLD OBJECTIVES
		/*"the captain's antique laser gun" = /obj/item/weapon/gun/energy/captain,		"a bluespace rift generator" = /obj/item/integrated_circuit/manipulation/bluespace_rift,
		"an RCD" = /obj/item/weapon/rcd,
		"a jetpack" = /obj/item/weapon/tank/jetpack,
		"a Statthalter's jumpsuit" = /obj/item/clothing/under/rank/captain,
//		"a functional AI" = /obj/item/weapon/aicard,
		...
		"a Direktor der Forschung's jumpsuit" = /obj/item/clothing/under/rank/research_director,
		"a Chefingenieur's jumpsuit" = /obj/item/clothing/under/rank/chief_engineer,
		"a chief medical officer's jumpsuit" = /obj/item/clothing/under/rank/chief_medical_officer,
		"a Kommandant's jumpsuit" = /obj/item/clothing/under/rank/head_of_security,
		"a Kanzler's jumpsuit" = /obj/item/clothing/under/rank/head_of_personnel,
		"the hypospray" = /obj/item/weapon/reagent_containers/hypospray,
		"the Statthalter's pinpointer" = /obj/item/weapon/pinpointer,
