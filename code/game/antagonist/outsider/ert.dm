...
/datum/antagonist/ert/New()
	..()
	leader_welcome_text = "As leader of the Emergency Response Team, you answer only to [using_map.boss_name], and have authority to override the Statthalter where it is necessary to achieve your mission goals. It is recommended that you attempt to cooperate with the captain where possible, however."
	ert = src
