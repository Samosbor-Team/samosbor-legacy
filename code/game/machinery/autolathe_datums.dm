...
/datum/autolathe/recipe/kar98k_ammo
	name = "Clip (7.92x57mm)"
	path = /obj/item/ammo_magazine/kar98k
	category = "Arms and Ammunition"

/datum/autolathe/recipe/stg_ammo
	name = "Stg-44 (7.92x33mm)"
	path = /obj/item/ammo_magazine/stg
	hidden = 1
	category = "Arms and Ammunition"

/datum/autolathe/recipe/mg34_drum
	name = "Mg34 drum magazine (7.92x57mm)"
	path = /obj/item/ammo_magazine/a762
	hidden = 1
	category = "Arms and Ammunition"

/datum/autolathe/recipe/mauser
	name = "C96 magazine (9 mm)"
	path = /obj/item/ammo_magazine/mauser
	hidden = 1
	category = "Arms and Ammunition"

/datum/autolathe/recipe/luger
	name = "luger magazine (9 mm)"
	path = /obj/item/ammo_magazine/luger
	hidden = 1
	category = "Arms and Ammunition"

/datum/autolathe/recipe/mp40
	name = "mp40 magazine (9 mm)"
	path = /obj/item/ammo_magazine/mp40
	hidden = 1
	category = "Arms and Ammunition"
