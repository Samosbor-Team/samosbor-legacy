...
/decl/flooring/tiling/rust
	icon_base = "rusty_ship2"

/decl/flooring/tiling/newluna
	icon_base = "floor_newluna"

/decl/flooring/tiling/padik
	icon_base = "padik"
	has_base_range = 2

/decl/flooring/tiling/plitka
	icon_base = "plitka_old"
	has_base_range = 8
