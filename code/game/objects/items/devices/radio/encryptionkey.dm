...
/obj/item/device/encryptionkey/heads/captain
	name = "Statthalter's encryption key"
...
/obj/item/device/encryptionkey/heads/rd
	name = "Direktor der Forschung's encryption key"
	icon_state = "rd_cypherkey"
	channels = list("Science" = 1, "Command" = 1)

/obj/item/device/encryptionkey/heads/kommandant
	name = "Kommandant's encryption key"
	icon_state = "hos_cypherkey"
	channels = list("Security" = 1, "Command" = 1)

/obj/item/device/encryptionkey/heads/ce
	name = "Chefingenieur's encryption key"
...
/obj/item/device/encryptionkey/headset_inquisition
	name = "geheimpolizei radio key"
	icon_state = "hos_cypherkey"
	channels = list("Geheimpolizei" = 1)
