...
/obj/item/toy/balloon/nanotrasen
	...
	desc = "Man, I love Kaiserliche Kolonialgenung soooo much. I use only NT products. You have NO idea."
...
/obj/item/toy/figure/captain
	name = "Statthalter action figure"
	desc = "A \"Space Life\" brand Statthalter action figure."
	icon_state = "captain"
...
/obj/item/toy/figure/kommandant
	name = "Kommandant action figure"
	desc = "A \"Space Life\" brand Kommandant action figure."
	icon_state = "hos"
