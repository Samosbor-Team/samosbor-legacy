...
/obj/item/weapon/card/id/captains_spare
	name = "Statthalter's spare ID"
	desc = "The spare ID of the High Lord himself."
	icon_state = "gold"
	item_state = "gold_id"
	registered_name = "Statthalter"
	assignment = "Statthalter"
...
/obj/item/weapon/card/id/civilian/head //This is not the Kanzler. There's no position that uses this right now.
	name = "identification card"
