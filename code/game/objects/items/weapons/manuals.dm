...
/obj/item/weapon/book/manual/nt_regs
	name = "Kaiserliche Kolonialgenung Regulations"
	desc = "A set of corporate guidelines for employees of Kaiserliche Kolonialgenung."
	icon_state = "booknanoregs"
	author = "Kaiserliche Kolonialgenung"
	title = "Kaiserliche Kolonialgenung Regulations"
...
/obj/item/weapon/book/manual/nuclear
	...
	dat = {"<html>
				...
				Intelligence Analysts believe that normal corporate procedure is for the Statthalter to secure the nuclear authentication disk.<br><br>
...
/obj/item/weapon/book/manual/evaguide
	...
	dat = {"<html>
				...
				These suits generally only fit one species. Kaiserliche Kolonialgenung's are usually human-fitting by default, but there's equipment that can make modifications to the hardsuits to fit them to other species.<BR><BR>
