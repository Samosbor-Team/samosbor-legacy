...
/obj/structure/sign/double/kaiserflag
	name = "Kaiserreich of Mankind Flag"
	desc = "The flag of the Kaiserreich of Mankind. Praise to Kaiser!"

/obj/structure/sign/double/kaiserflag/left
	icon_state = "kaiserflag-left"

/obj/structure/sign/double/kaiserflag/right
	icon_state = "kaiserflag-right"

/obj/structure/sign/iron_cross
	name = "Kaiserreich Iron Cross"
...
/obj/structure/sign/nanotrasen
	name = "\improper Kaiserliche Kolonialgenung"
	desc = "An old metal sign which reads 'Kaiserliche Kolonialgenung'."
	icon_state = "NT"
