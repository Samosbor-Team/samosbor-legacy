...
/obj/structure/bedsheetbin/attack_hand(mob/living/user as mob)
	if(samosbor)
		to_chat(user, "<span class='warning'>You tried to take bed sheet out of [src] but something bited your hand!")
		user.apply_damage(rand(1,10), BRUTE, pick(BP_R_HAND, BP_L_HAND))
		return
