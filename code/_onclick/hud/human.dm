...
/datum/hud/proc/human_hud(var/ui_style='icons/mob/screen1_White.dmi', var/ui_color = "#ffffff", var/ui_alpha = 255, var/mob/living/carbon/human/target)
	...
	if(hud_data.has_hands)
		...
		*/
		...
		mymob.rhand_ext = new /obj/screen()
		mymob.rhand_ext.name = ""
		mymob.rhand_ext.icon = ui_style
		mymob.rhand_ext.icon_state = "bottom_right"
		mymob.rhand_ext.screen_loc = ui_rhand_ext
		mymob.rhand_ext.color = ui_color
		mymob.rhand_ext.alpha = ui_alpha
		hud_elements |= mymob.rhand_ext
		...
		mymob.lhand_ext = new /obj/screen()
		mymob.lhand_ext.name = ""
		mymob.lhand_ext.icon = ui_style
		mymob.lhand_ext.icon_state = "bottom_left"
		mymob.lhand_ext.screen_loc = ui_lhand_ext
		mymob.lhand_ext.color = ui_color
		mymob.lhand_ext.alpha = ui_alpha
		hud_elements |= mymob.lhand_ext
	...
	*/
	...
	mymob.rest_icon.icon_state = "act_rest"
	mymob.rest_icon.name = "rest"
	mymob.rest_icon.screen_loc = ui_rest
	hud_elements |= mymob.rest_icon


	mymob.rwire = new /obj/screen()
	mymob.rwire.icon = ui_style
	mymob.rwire.icon_state = "wires_right"
	mymob.rwire.name = "rest"
	mymob.rwire.screen_loc = ui_right_wires
	hud_elements |= mymob.rwire

	mymob.lwire = new /obj/screen()
	mymob.lwire.icon = ui_style
	mymob.lwire.icon_state = "wires_left"
	mymob.lwire.name = "rest"
	mymob.lwire.screen_loc = ui_left_wires
	hud_elements |= mymob.lwire
	...
	mymob.noise.icon = 'icons/mob/screen_full.dmi'
	mymob.noise.icon_state = "noise"
	mymob.noise.name = " "
	mymob.noise.screen_loc = "CENTER-7,CENTER-7"
	mymob.noise.mouse_opacity = 0
	mymob.noise.blend_mode = 4
	mymob.noise.alpha = 40
	hud_elements |= mymob.noise

	mymob.color_overlay = new /obj/screen()
	mymob.color_overlay.icon = 'icons/samosbor/mob/color_overlay.dmi'
	mymob.color_overlay.icon_state = "overlay"
	mymob.color_overlay.name = " "
	mymob.color_overlay.screen_loc = "1,1 to 15,15"
	mymob.color_overlay.mouse_opacity = 0
	mymob.color_overlay.blend_mode = 4 //Не помню что это хуйн# означает. Скорее всего BLEND_MULTIPLY.
	mymob.color_overlay.alpha = 180
	mymob.color_overlay.plane = 3
	mymob.color_overlay.layer = 1
	hud_elements |= mymob.color_overlay
