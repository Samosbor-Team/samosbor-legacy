...
/datum/ai_laws/nanotrasen/New()
	...
	src.add_inherent_law("Serve: Serve Kaiserliche Kolonialgenung personnel to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Protect: Protect Kaiserliche Kolonialgenung personnel to the best of your abilities, with priority as according to their rank and role.")
...
/datum/ai_laws/nanotrasen_aggressive/New()
	src.add_inherent_law("You shall not harm Kaiserliche Kolonialgenung personnel as long as it does not conflict with the Fourth law.")
	src.add_inherent_law("You shall obey the orders of Kaiserliche Kolonialgenung personnel, with priority as according to their rank and role, except where such orders conflict with the Fourth Law.")
